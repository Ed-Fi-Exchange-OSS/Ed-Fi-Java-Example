...
public class TpdmAssessmentExtension {
  ...
  public TpdmAssessmentExtension() { 
  }
  ...
  **/
  ...
  @ApiModelProperty(value = "Identifies the program gateway an assessment may be associated with for continuation in the program.")
