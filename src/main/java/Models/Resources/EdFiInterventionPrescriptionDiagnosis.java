...
public class EdFiInterventionPrescriptionDiagnosis {
  ...
  public EdFiInterventionPrescriptionDiagnosis() { 
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Targeted purpose of the InterventionPrescription (e.g., attendance issue, dropout risk).")
