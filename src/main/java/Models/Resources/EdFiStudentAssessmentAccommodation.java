...
public class EdFiStudentAssessmentAccommodation {
  public static final String SERIALIZED_NAME_ACCOMMODATION_DESCRIPTOR = "accommodationDescriptor";
  @SerializedName(SERIALIZED_NAME_ACCOMMODATION_DESCRIPTOR)
  private String accommodationDescriptor;

  public EdFiStudentAssessmentAccommodation() { 
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The specific type of special variation used in how an examination is presented, how it is administered, or how the test taker is allowed to respond. This generally refers to changes that do not substantially alter what the examination measures. The proper use of accommodations does not substantially change academic level or performance criteria. For example:         Braille         Enlarged monitor view         Extra time         Large Print         Setting         Oral Administration         ...")
