...
public class EdFiContractedStaff {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The date of the reported contracted staff element.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Current balance (amount paid to contractor) for account for the fiscal year.")
