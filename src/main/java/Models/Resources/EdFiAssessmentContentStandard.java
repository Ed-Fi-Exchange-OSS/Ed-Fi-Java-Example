...
import Models.Resources.EdFiAssessmentContentStandardAuthor;
...
public class EdFiAssessmentContentStandard {
  ...
  private List<EdFiAssessmentContentStandardAuthor> authors = null;

  public EdFiAssessmentContentStandard() { 
  }
  ...
  **/
  ...
  public EdFiAssessmentContentStandard addAuthorsItem(EdFiAssessmentContentStandardAuthor authorsItem) {
    if (this.authors == null) {
      this.authors = new ArrayList<EdFiAssessmentContentStandardAuthor>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An unordered collection of assessmentContentStandardAuthors. The person or organization chiefly responsible for the intellectual content of the standard.")
