...
import Models.Resources.EdFiStudentEducationOrganizationAssociationAddressPeriod;
...
public class EdFiStudentEducationOrganizationAssociationAddress {
  ...
  private List<EdFiStudentEducationOrganizationAssociationAddressPeriod> periods = null;

  public EdFiStudentEducationOrganizationAssociationAddress() { 
  }
  ...
  **/
  ...
  public EdFiStudentEducationOrganizationAssociationAddress addPeriodsItem(EdFiStudentEducationOrganizationAssociationAddressPeriod periodsItem) {
    if (this.periods == null) {
      this.periods = new ArrayList<EdFiStudentEducationOrganizationAssociationAddressPeriod>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An unordered collection of studentEducationOrganizationAssociationAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address.")
