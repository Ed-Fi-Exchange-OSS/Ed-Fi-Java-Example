...
import Models.Resources.EdFiLearningObjectiveContentStandardAuthor;
...
public class EdFiLearningObjectiveContentStandard {
  ...
  private List<EdFiLearningObjectiveContentStandardAuthor> authors = null;
  ...
  **/
  ...
  public EdFiLearningObjectiveContentStandard addAuthorsItem(EdFiLearningObjectiveContentStandardAuthor authorsItem) {
    if (this.authors == null) {
      this.authors = new ArrayList<EdFiLearningObjectiveContentStandardAuthor>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An unordered collection of learningObjectiveContentStandardAuthors. The person or organization chiefly responsible for the intellectual content of the standard.")
