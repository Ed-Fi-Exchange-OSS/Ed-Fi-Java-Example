...
import Models.Resources.EdFiStaffLanguageUse;
...
public class EdFiStaffLanguage {
  ...
  private List<EdFiStaffLanguageUse> uses = null;

  public EdFiStaffLanguage() { 
  }
  ...
  **/
  ...
  public EdFiStaffLanguage addUsesItem(EdFiStaffLanguageUse usesItem) {
    if (this.uses == null) {
      this.uses = new ArrayList<EdFiStaffLanguageUse>();
    }
  ...
  **/
  ...
  @ApiModelProperty(value = "An unordered collection of staffLanguageUses. A description of how the language is used (e.g. Home Language, Native Language, Spoken Language).")
