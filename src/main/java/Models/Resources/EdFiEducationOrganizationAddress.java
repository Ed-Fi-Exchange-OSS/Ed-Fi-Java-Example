...
import Models.Resources.EdFiEducationOrganizationAddressPeriod;
...
public class EdFiEducationOrganizationAddress {
  ...
  private List<EdFiEducationOrganizationAddressPeriod> periods = null;
  ...
  **/
  ...
  public EdFiEducationOrganizationAddress addPeriodsItem(EdFiEducationOrganizationAddressPeriod periodsItem) {
    if (this.periods == null) {
      this.periods = new ArrayList<EdFiEducationOrganizationAddressPeriod>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An unordered collection of educationOrganizationAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address.")
