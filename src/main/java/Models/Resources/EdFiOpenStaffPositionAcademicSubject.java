...
public class EdFiOpenStaffPositionAcademicSubject {
  ...
  public EdFiOpenStaffPositionAcademicSubject() { 
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The teaching field required for the OpenStaffPosition, for example English/Language Arts, Reading, Mathematics, Science, Social Sciences, etc.")
