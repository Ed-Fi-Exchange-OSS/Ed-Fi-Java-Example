...
import Models.Resources.EdFiStaffEducationOrganizationContactAssociationAddressPeriod;
...
public class EdFiStaffEducationOrganizationContactAssociationAddress {
  ...
  private List<EdFiStaffEducationOrganizationContactAssociationAddressPeriod> periods = null;
  ...
  **/
  ...
  public EdFiStaffEducationOrganizationContactAssociationAddress addPeriodsItem(EdFiStaffEducationOrganizationContactAssociationAddressPeriod periodsItem) {
    if (this.periods == null) {
      this.periods = new ArrayList<EdFiStaffEducationOrganizationContactAssociationAddressPeriod>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An unordered collection of staffEducationOrganizationContactAssociationAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address.")
