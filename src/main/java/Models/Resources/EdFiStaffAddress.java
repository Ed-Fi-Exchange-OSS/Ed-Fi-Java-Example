...
import Models.Resources.EdFiStaffAddressPeriod;
...
public class EdFiStaffAddress {
  ...
  private List<EdFiStaffAddressPeriod> periods = null;

  public EdFiStaffAddress() { 
  }
  ...
  **/
  ...
  public EdFiStaffAddress addPeriodsItem(EdFiStaffAddressPeriod periodsItem) {
    if (this.periods == null) {
      this.periods = new ArrayList<EdFiStaffAddressPeriod>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An unordered collection of staffAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address.")
