...
public class EdFiInterventionAppropriateGradeLevel {
  ...
  public EdFiInterventionAppropriateGradeLevel() { 
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Grade levels for the Intervention-if omitted, considered generally applicable.")
