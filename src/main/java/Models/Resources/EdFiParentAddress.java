...
import Models.Resources.EdFiParentAddressPeriod;
...
public class EdFiParentAddress {
  ...
  private List<EdFiParentAddressPeriod> periods = null;

  public EdFiParentAddress() { 
  }
  ...
  **/
  ...
  public EdFiParentAddress addPeriodsItem(EdFiParentAddressPeriod periodsItem) {
    if (this.periods == null) {
      this.periods = new ArrayList<EdFiParentAddressPeriod>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An unordered collection of parentAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address.")
