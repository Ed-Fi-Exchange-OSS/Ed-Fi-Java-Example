...
public class EdFiCourseOfferingOfferedGradeLevel {
  ...
  public EdFiCourseOfferingOfferedGradeLevel() { 
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The grade levels in which the course is offered. This collection should only be populated if it differs from the Offered Grade Levels identified at the Course level.")
