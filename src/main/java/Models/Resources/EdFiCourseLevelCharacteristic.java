...
public class EdFiCourseLevelCharacteristic {
  ...
  public EdFiCourseLevelCharacteristic() { 
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The type of specific program or designation with which the course is associated (e.g., AP, IB, Dual Credit, CTE).")
