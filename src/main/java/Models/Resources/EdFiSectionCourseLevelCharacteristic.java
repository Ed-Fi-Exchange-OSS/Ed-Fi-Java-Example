...
public class EdFiSectionCourseLevelCharacteristic {
  ...
  public EdFiSectionCourseLevelCharacteristic() { 
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The type of specific program or designation with which the section is associated (e.g., AP, IB, Dual Credit, CTE). This collection should only be populated if it differs from the Course Level Characteristics identified at the Course Offering level.")
