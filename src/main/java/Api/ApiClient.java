...
import Api.auth.HttpBasicAuth;
import Api.auth.HttpBearerAuth;
import Api.auth.ApiKeyAuth;
import Api.auth.OAuth;
import Api.auth.RetryingOAuth;
import Api.auth.OAuthFlow;
...
public class ApiClient {
    ...
    private String basePath = "https://api.ed-fi.org:443/v5.2/api/data/v3";
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://api.ed-fi.org/v5.2/api/oauth/token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.ed-fi.org:443/v5.2/api/data/v3
